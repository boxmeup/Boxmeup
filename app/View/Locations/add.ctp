...
?>
	...
	?>
		<img class="preview-map img-responsive" src="http://maps.googleapis.com/maps/api/staticmap?size=400x350&sensor=false&maptype=roadmap&markers=size:small|color:red|<?php echo $address ?>" />
	</div>
</div>
