...
<?php
	echo $this->Html->link('Delete Item', array('controller' => 'container_items', 'action' => 'delete', $item_uuid), array('escape' => false, 'data-role' => 'button', 'data-icon' => 'delete', 'data-theme' => 'a'));
?>
	</div>
	<div class="ui-block-b">
<?php
	echo $this->Form->submit('Save Item', array('class' => 'btn success', 'div' => false, 'data-icon' => 'check'));
?>
	</div>
</div>
<?php
