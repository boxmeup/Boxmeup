...
<body>
	<div data-role="page" data-theme="<?php echo Configure::read('Site.jquery_mobile_theme'); ?>" id="<?php echo $mobile_page_id; ?>">
		...
		<?php
		if($this->name == 'Containers' && $this->request->action == 'index' && !empty($User))
		...
		else if($this->name !== 'Pages' && $this->request->action !== 'home')
			echo $this->Html->link('Home', '/', array('data-ajax' => 'false', 'data-iconpos' => 'notext', 'data-icon' => 'home', 'class' => 'ui-btn-right'))
		?>
