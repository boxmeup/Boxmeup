...
<div style="width: 900px; margin: 0 auto;">
	<div style="width: 250px; float: left; padding: 10px 20px;">
		<h2 style="text-align: center"><?php __('Moving'); ?></h2>
		<p><?php __("Can't remember where you packed your toothbrush?  Use our search feature to find it!"); ?></p>
	</div>
	<div style="width: 250px; float: left; padding: 10px 20px;">
		<h2 style="text-align: center"><?php __('Collectors'); ?></h2>
		<p><?php __('Collect baseball cards, comic books, or stamps?  Use this app to organize your collection.'); ?></p>
	</div>
	<div style="width: 250px; float: left; padding: 10px 20px;">
		<h2 style="text-align: center"><?php __('Mobile'); ?></h2>
		<p><?php __('Use your smartphone to scan labels to pull up a manifest anywhere.'); ?></p>
	</div>
</div>