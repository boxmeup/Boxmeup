<div id="auth">
	...
	<?php
		if(!empty($User)) {
			...
			echo $html->tag('li', $html->link(__('Sign Up', true), '/signup', array('class' => 'large green button')));
			echo $html->tag('li', $html->link(__('Login', true), '/login', array('class' => 'large blue button')));
		}
	?>
	</ul>
	<div id="language">
